...
class AuthMain extends React.Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <Router>
                    <img src={`http://wixcore.gta5srv.com/system/public/images/brand/logotype/light_v1.svg`} style={{zIndex: 2, position: 'absolute', marginTop: '2rem', marginLeft: '2rem', width: '150px'}} />
