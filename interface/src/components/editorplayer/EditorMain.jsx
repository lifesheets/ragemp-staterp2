        ...
        return (
            <React.Fragment>
                <div id="disableZoom" className="adaptive_editor">
                    <img src={`http://wixcore.gta5srv.com/public/images/brand/logotype/light_v1.svg`} style={{zIndex: 2, position: 'absolute', marginTop: '2rem', marginLeft: '3.4rem', width: '6rem'}} />
