...
function notify(type, layout, message, time, theme) {
    ...
    switch (theme) {
        case 'error':       notifyText = 'Ошибка!';             break;
        case 'warning':     notifyText = 'Предупреждение!';     break;
        case 'info':        notifyText = 'Информация!';         break;
        case 'success':     notifyText = 'Успешно!';            break;
        default:                                                break;
    }

    switch (type) {
        case 0:             notifyText = 'Информация!';         break;
        case 1:             notifyText = 'Ошибка!';             break;
        case 2:             notifyText = 'Успешно!';            break;
        case 3:             notifyText = 'Предупреждение!';     break;
        default:                                                break;
    }
