...
family.loadAll = function() {
    WixCore.Function.Debug.Server('family.loadAll');
    ...
    mysql.executeQuery(`SELECT * FROM family_list`, function (err, rows, fields) {
        ...
        count = rows.length;
        WixCore.Function.Debug.Server('All Family Loaded: ' + count);
    });
};

family.loadById = function(id) {
    WixCore.Function.Debug.Server('family.loadById');
...
family.saveAll = function() {
    WixCore.Function.Debug.Server('family.saveAll');
    mysql.executeQuery(`SELECT * FROM family_list`, function (err, rows, fields) {
        rows.forEach(function(item) {
            family.save(item['id']);
        });
...
family.getCount = function() {
    WixCore.Function.Debug.Server('family.getCount');
    return count;
};
...
family.save = function(id) {
    ...
    return new Promise((resolve) => {
        WixCore.Function.Debug.Server('family.save');
...
family.updateOwnerInfo = function (id, userId) {
    WixCore.Function.Debug.Server('family.updateOwnerInfo');
    id = methods.parseInt(id);
...
family.create = function (player, name) {
    ...
    WixCore.Function.Debug.Server('family.create');
...
family.destroy = function (player, id) {
    ...
    id = methods.parseInt(id);
    WixCore.Function.Debug.Server('family.destroy');
