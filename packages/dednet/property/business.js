...
business.loadAll = function() {
    WixCore.Function.Debug.Server('business.loadAll');
    mysql.executeQuery(`SELECT * FROM business`, function (err, rows, fields) {
        ...
        WixCore.Function.Debug.Server('All Business Loaded: ' + rows.length);
    });
};

business.save = function(id) {
    WixCore.Function.Debug.Server('business.save');
...
business.updateOwnerInfo = function (bId, userId, userName) {
    WixCore.Function.Debug.Server('business.updateOwnerInfo');
...
business.sell = function (player) {
    WixCore.Function.Debug.Server('business.sell');
...
business.buy = function (player, id) {
    WixCore.Function.Debug.Server('business.buy');
