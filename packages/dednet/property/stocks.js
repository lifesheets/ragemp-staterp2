...
stocks.loadAll = function() {
    WixCore.Function.Debug.Server('stocks.loadAll');
    ...
    mysql.executeQuery(`SELECT * FROM stocks`, function (err, rows, fields) {
        ...
        count = rows.length;
        WixCore.Function.Debug.Server('All stocks Loaded: ' + count);
    });
...
stocks.loadLast = function() {
    WixCore.Function.Debug.Server('stocks.loadLast');
...
stocks.insert = function(player, number, street, zone, x, y, z, rot, interior, price) {
    WixCore.Function.Debug.Server('stocks.insert');
...
stocks.insert2 = function(player, id, vx, vy, vz, vrot) {
    WixCore.Function.Debug.Server('stocks.insert2');
...
stocks.removeState = function() {
    WixCore.Function.Debug.Server('stocks.removeState');
    mysql.executeQuery(`SELECT * FROM stocks`, function (err, rows, fields) {
        rows.forEach(function(item) {
            try {
...
stocks.saveAll = function() {
    WixCore.Function.Debug.Server('stocks.saveAll');
    mysql.executeQuery(`SELECT * FROM stocks`, function (err, rows, fields) {
        rows.forEach(function(item) {
            stocks.save(item['id']);
        });
...
stocks.save = function(id) {
    ...
    return new Promise((resolve) => {
        WixCore.Function.Debug.Server('stocks.save');
...
stocks.sellBySlot = function (player, slot) {
    WixCore.Function.Debug.Server('stocks.sell');
    if (!user.isLogin(player))
        return;
...
stocks.getAll = function() {
    WixCore.Function.Debug.Server('stocks.getAll');
    return stockList;
};
...
stocks.updateOwnerInfo = function (id, userId, userName) {
    WixCore.Function.Debug.Server('stocks.updateOwnerInfo');
...
stocks.updateUpgradeG = function (id, status) {
    WixCore.Function.Debug.Server('stocks.updateUpgradeG');
...
stocks.updateUpgradeB = function (id, status) {
    WixCore.Function.Debug.Server('stocks.updateUpgradeB');
    if (typeof status === "boolean") {
        if (status)
            status = 1;
        else
...
stocks.updateUpgradeL = function (id, status) {
    WixCore.Function.Debug.Server('stocks.updateUpgradeL');
    if (typeof status === "boolean") {
        if (status)
            status = 1;
        else
...
stocks.updateUpgradeN = function (id, status) {
    WixCore.Function.Debug.Server('stocks.updateUpgradeN');
    if (typeof status === "boolean") {
        if (status)
            status = 1;
        else
...
stocks.updatePin = function (id, pin) {
    WixCore.Function.Debug.Server('stocks.updatePin');
    id = methods.parseInt(id);
...
stocks.updatePinL = function (id, pin) {
    WixCore.Function.Debug.Server('stocks.updatePinL');
    id = methods.parseInt(id);
    pin = methods.parseInt(pin);
...
stocks.updatePinB = function (id, pin) {
    WixCore.Function.Debug.Server('stocks.updatePinB');
    id = methods.parseInt(id);
    pin = methods.parseInt(pin);
...
stocks.labStart = function (id, type, count) {
    WixCore.Function.Debug.Server('stocks.labStart');
...
stocks.buy = function (player, id) {
    WixCore.Function.Debug.Server('stocks.buy');
...
stocks.enter = function (player, id) {
    WixCore.Function.Debug.Server('stocks.enter', id);
