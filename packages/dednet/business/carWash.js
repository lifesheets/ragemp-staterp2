...
carWash.loadAll = function() {
    WixCore.Function.Debug.Server('carWash.loadAll');
...
carWash.getInRadius = function(pos, radius = 2) {
    WixCore.Function.Debug.Server('carWash.getInRadius');
    let shopId = -1;
...
carWash.checkPosForOpenMenu = function(player) {
    WixCore.Function.Debug.Server('carWash.checkPosForOpenMenu');
    try {
